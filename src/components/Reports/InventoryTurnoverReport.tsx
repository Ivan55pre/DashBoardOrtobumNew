...
const InventoryTurnoverReport: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (hasRealData) {
      ...
      if (reportError) console.error('Error loading inventory turnover report data:', reportError)
      itemsToProcess = []
    }
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-dark-800 divide-y divide-gray-200 dark:divide-gray-700">
            {data.length > 0 ? (
              ...
              <tr>
                <td colSpan={8} className="text-center py-10 px-6 text-gray-500 dark:text-gray-400">
                  Нет данных для отображения.
                </td>
              </tr>
            )}
